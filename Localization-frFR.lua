-- Need help for full translation in French!!
...
if (GetLocale() == "frFR") then
    ...
    TXT_RAIDWARNING_ON  = "AntiDaze: Send Raid Warnings on";
    TXT_RAIDWARNING_OFF = "AntiDaze: Send Raid Warnings off";
    TXT_CHATMESSAGE_ON  = "AntiDaze: Send Chat Messages on";
    TXT_CHATMESSAGE_OFF = "AntiDaze: Send Chat Messages off";
    ...
    OPT_RAIDWARNING		= "Use Raid Warnings (for yourself only)";
    OPT_CHATMESSAGE		= "Use Chat Messages (for yourself only)";
    OPT_WHISPER			= "Send Whisper to offending player";
	BUFF_DAZED			= "Hébétement";
	SPELL_CHEETAH			= "Aspect du guépard";
	SPELL_PACK			= "Aspect de la meute";
end
